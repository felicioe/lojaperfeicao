...
import { parearLotePorOrdem } from "./conciliacao-pareamento";
...
// parearLotePorOrdem foi extraída pra conciliacao-pareamento.ts (issue
// #510) — reutilizada também em dashboard.ts e fluxo-caixa.ts, que tinham
// a mesma reconstrução de data ausente e mostravam o recebimento em lote
// no mês de processamento do lote em vez do mês real do pagamento.
