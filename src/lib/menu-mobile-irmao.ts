...
export const ITENS_MOBILE_IRMAO: ItemMobileIrmao[] = [
  {
    ...
    onPrimary: "text-emerald-300 dark:text-emerald-900",
  },
  {
    to: "/painel/sessoes",
    label: "Sessões",
    ...
    onPrimary: "text-indigo-300 dark:text-indigo-900",
  },
  {
    ...
    onPrimary: "text-rose-300 dark:text-rose-900",
  },
  {
    to: "/painel/eventos",
    label: "Eventos",
    ...
    onPrimary: "text-fuchsia-300 dark:text-fuchsia-900",
  },
  {
    ...
    onPrimary: "text-blue-300 dark:text-blue-900",
  },
  {
    to: "/painel/dados",
    label: "Meus Dados",
  ...
  },
  {
    ...
    onPrimary: "text-teal-300 dark:text-teal-900",
  },
  {
    to: "/calendario",
    label: "Calendário",
    ...
    onPrimary: "text-sky-300 dark:text-sky-900",
  },
  {
    to: "/enquetes",
    label: "Enquetes",
    ...
    onPrimary: "text-violet-300 dark:text-violet-900",
  },
  {
    to: "/documentos",
    label: "Legislação",
    ...
    onPrimary: "text-amber-300 dark:text-amber-900",
  },
  {
    to: "/painel/chamados",
    ...
    onPrimary: "text-orange-300 dark:text-orange-900",
  },
];
